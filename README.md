...
``` ts 
import makeWASocket from '@darkcriminal/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@darkcriminal/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@darkcriminal/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@darkcriminal/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@darkcriminal/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@darkcriminal/baileys'
                                */
...
import { downloadMediaMessage } from '@darkcriminal/baileys'
